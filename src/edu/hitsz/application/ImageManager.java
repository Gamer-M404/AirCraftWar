...
import edu.hitsz.aircraft.enemies.*;
...
public class ImageManager {
    ...
    public static BufferedImage PROP_FREEZE;
    ...
    static {
        try {
            ...
            PROP_FREEZE = ImageIO.read(new FileInputStream("src/images/prop_freeze.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(PropFreeze.class.getName(), PROP_FREEZE);
